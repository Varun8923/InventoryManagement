...
namespace Inventory.Utility
{
    ...
    namespace ERP.Core
    {
        public class EmailSender
        {
            ...
            {
                this.SenderId = "guptavarun934@gmail.com";//ConfigurationManager.AppSettings["EmailId"];
                this.SenderPass = "ovke ckju finq srze";//ConfigurationManager.AppSettings["MailPass"]; 
                this.SendTo = SendTo;
